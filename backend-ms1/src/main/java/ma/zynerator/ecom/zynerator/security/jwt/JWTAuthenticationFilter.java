package ma.zynerator.ecom.zynerator.security.jwt;
...
import ma.zynerator.ecom.EcomApplication;
import ma.zynerator.ecom.zynerator.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = EcomApplication.getCtx().getBean(UserService.class);
