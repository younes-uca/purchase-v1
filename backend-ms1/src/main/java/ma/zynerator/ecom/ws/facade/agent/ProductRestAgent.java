package  ma.zynerator.ecom.ws.facade.agent;
...
public class ProductRestAgent  extends AbstractController<Product, ProductDto, ProductHistory, ProductCriteria, ProductHistoryCriteria, ProductAgentService, ProductConverter> {
    ...
    public ProductRestAgent (ProductAgentService service, ProductConverter converter) {
