...
@Component({
  selector: 'app-client-create-agent',
  templateUrl: './client-create-agent.component.html'
})
export class ClientCreateAgentComponent extends AbstractCreateController<ClientDto, ClientCriteria, ClientService>  implements OnInit {
