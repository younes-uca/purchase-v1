...
@Component({
  selector: 'app-client-edit-agent',
  templateUrl: './client-edit-agent.component.html'
})
export class ClientEditAgentComponent extends AbstractEditController<ClientDto, ClientCriteria, ClientService>   implements OnInit {
