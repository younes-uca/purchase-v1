...
@Component({
  selector: 'app-client-category-create-agent',
  templateUrl: './client-category-create-agent.component.html'
})
export class ClientCategoryCreateAgentComponent extends AbstractCreateController<ClientCategoryDto, ClientCategoryCriteria, ClientCategoryService>  implements OnInit {
