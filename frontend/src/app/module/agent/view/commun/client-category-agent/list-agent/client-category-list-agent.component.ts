...
@Component({
  selector: 'app-client-category-list-agent',
  templateUrl: './client-category-list-agent.component.html'
})
export class ClientCategoryListAgentComponent extends AbstractListController<ClientCategoryDto, ClientCategoryCriteria, ClientCategoryService>  implements OnInit {
