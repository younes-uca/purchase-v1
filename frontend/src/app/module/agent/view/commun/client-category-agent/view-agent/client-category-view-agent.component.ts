...
@Component({
  selector: 'app-client-category-view-agent',
  templateUrl: './client-category-view-agent.component.html'
})
export class ClientCategoryViewAgentComponent extends AbstractViewController<ClientCategoryDto, ClientCategoryCriteria, ClientCategoryService> implements OnInit {
