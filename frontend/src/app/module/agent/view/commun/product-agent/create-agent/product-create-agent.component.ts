...
@Component({
  selector: 'app-product-create-agent',
  templateUrl: './product-create-agent.component.html'
})
export class ProductCreateAgentComponent extends AbstractCreateController<ProductDto, ProductCriteria, ProductService>  implements OnInit {
