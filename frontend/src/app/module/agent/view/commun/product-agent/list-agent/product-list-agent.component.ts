...
@Component({
  selector: 'app-product-list-agent',
  templateUrl: './product-list-agent.component.html'
})
export class ProductListAgentComponent extends AbstractListController<ProductDto, ProductCriteria, ProductService>  implements OnInit {
