...
@Component({
  selector: 'app-product-view-agent',
  templateUrl: './product-view-agent.component.html'
})
export class ProductViewAgentComponent extends AbstractViewController<ProductDto, ProductCriteria, ProductService> implements OnInit {
