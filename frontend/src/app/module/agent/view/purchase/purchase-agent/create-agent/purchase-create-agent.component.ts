...
@Component({
  selector: 'app-purchase-create-agent',
  templateUrl: './purchase-create-agent.component.html'
})
export class PurchaseCreateAgentComponent extends AbstractCreateController<PurchaseDto, PurchaseCriteria, PurchaseService>  implements OnInit {
