...
@Component({
  selector: 'app-purchase-list-agent',
  templateUrl: './purchase-list-agent.component.html'
})
export class PurchaseListAgentComponent extends AbstractListController<PurchaseDto, PurchaseCriteria, PurchaseService>  implements OnInit {
