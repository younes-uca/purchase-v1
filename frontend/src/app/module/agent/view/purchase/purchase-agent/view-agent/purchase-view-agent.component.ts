...
@Component({
  selector: 'app-purchase-view-agent',
  templateUrl: './purchase-view-agent.component.html'
})
export class PurchaseViewAgentComponent extends AbstractViewController<PurchaseDto, PurchaseCriteria, PurchaseService> implements OnInit {
