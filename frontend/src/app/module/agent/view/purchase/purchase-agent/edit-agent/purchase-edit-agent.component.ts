...
@Component({
  selector: 'app-purchase-edit-agent',
  templateUrl: './purchase-edit-agent.component.html'
})
export class PurchaseEditAgentComponent extends AbstractEditController<PurchaseDto, PurchaseCriteria, PurchaseService>   implements OnInit {
